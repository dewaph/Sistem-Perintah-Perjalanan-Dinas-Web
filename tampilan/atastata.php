...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <ul class="list">
                   ...
                   <!-- <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="inputspd.php">Input Surat Perjalanan Dinas</a>
                            </li>
                            <li>
                                <a href="spd.php">Cetak Surat Perjalanan Dinas</a>
                            </li>
                            <li>
                                <a href="kwitansi.php">Cetak Kwitansi</a>
                            </li>
                               </ul>
                     </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2022 <a href="javascript:void(0);"></a>
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
